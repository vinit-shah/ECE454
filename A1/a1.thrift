...
service BcryptService {
 ...
 list<string> hashPasswordAsync (1: list<string> password, 2: i16 logRounds) throws (1: IllegalArgument e);
 list<bool> checkPasswordAsync (1: list<string> password, 2: list<string> hash) throws (1: IllegalArgument e);
